      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-6">{t('footer.quickLinks')}</h3>
        ...
        <div className="border-t border-orange-100/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-8 mt-6 md:mt-0">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/thinktech17" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-heritage-gold transition-all duration-300 hover:scale-110 transform group" aria-label="LinkedIn">
            ...
            {/* GitHub */}
            <a href="https://github.com/iapoorv01/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-heritage-gold transition-all duration-300 hover:scale-110 transform group" aria-label="GitHub">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/i__apoorv__01/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-heritage-gold transition-all duration-300 hover:scale-110 transform group" aria-label="Instagram">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
